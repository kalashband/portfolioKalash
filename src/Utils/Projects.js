export const projects = [
  {
    ...
    title: "Nike clone",
    des:
      "A web application to buy sports and fashion accessories along with the suitable clothes.",
    demo: "",
  ...
  {
    img: "https://github.com/kalashband/ZipCodeInfo/blob/master/image.png?raw=true",
  ...
  // 	title: 'Web App Migration on AWS',
  // 	des: 'Enhanced web app usability on AWS by collaborating on migration, deploying Docker for portability, optimizing VPC/ELB for secure networking, and leveraging ECR for image management in a comprehensive AWS setup. ',
  // 	demo: '',
  // 	live: '#',
  // 	gitHub: '#',
  // 	technologies: ['Docker', 'AWS', 'ECS', 'ECR', 'VPC'],
  // },
  // {
